...
*/
		...
		_updateVolume: function(v) {
			...
			if(this.css.jq.volumeBarValue.length) {
				...
				// Acá abajo hago que el volumen se muestre en el tooltip
				// Modificación realizada el 15.02.2013 a las 16:00
				// Por Adrian Barabino, por supuesto, para BroteColectivo.com :D 
				var volumen_actual = new String(v*100);
				var volumen_actual_title = "El volumen actual es "+volumen_actual.substring(0,4);
				$(".jp-volume-bar").attr("data-original-title", volumen_actual_title);
