	var artistas_json;
	var boton_volver='<div class="main-top"><div id="contenidoTop" style="margin-top:-1em;margin-bottom:0.5em;"><a class="btn btn-mini btn-success" id="boton_volver" href="javascript:void(0);"><i class="icon-long-arrow-left  icon-large"></i> Volver</a></div>';
...
$(document).ready(function(){
	...
	$(document).on("click", "#slider > li > a", navegacion);
