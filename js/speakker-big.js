 ...
 *
 * This is Speakker Bigboy powered by Projekktor II Core Version: V1.2.16 rr178
...
projekktor = $p = function() {
	...
	this.config = new projekktorConfig('1.2.16');
...
*/
            ...
            var ref = this,
                set = (this.getConfig('keys').length > 0)
                    ...
                    : [{
                        ...
                        38: function(player, evt) {player.setVolume('+5'); evt.preventDefault();},
                        40: function(player, evt) {player.setVolume('-5'); evt.preventDefault();},
	...
	this._canPlay = function(type, platform, streamType) {
		...
		$p._compTableCache = this._testMediaSupport();
            ...
            $.each(pltfrm, function(key, plt) {
                ...
                if (plt!=null) plt = plt.toUpperCase();
	...
	*/
	this.getNativeFullscreenSupport = function() {
	    ...
	    fullScreenApi.isFullScreen = function() {
                // seems to be the most robust way to do:
	...
	*******************************/
	this.setActiveItem = function(mixedData) {
	    ...
	    // regular "autoplay" on:
	    if (newItem===0 && (lastItem==null || lastItem==newItem) && (this.config._autoplay===true || 'AWAKENING'.indexOf(this.getState())>-1) ) {
		ap = true;
	    }
	    //  "continuous" playback?
	...
	this.setFullscreen = function(goFull) {
	    ...
	    goFull = (goFull==null) ? !nativeFullscreen.isFullScreen() : goFull;                                
            // causes issues in conjunction with googleTV (isfullscreen always returns false)
...
projekktorPluginInterface.prototype = {
    ...
    */
    applyToPlayer: function(element, fu, visible) {
        ...
        this._childDOMContainer[func] = this.playerDom.find("["+this.getDA('func')+"='"+func+"'],."+this.getCN(this.name) + "["+this.getDA('func')+"!='container']");
    ...
    playingListener: function(obj) {
        ...
        (function() {
		    ...
		    return;
                ...
                if (ref.mediaElement[0].seekable && ref.mediaElement[0].seekable.length>0) {
...
playerModel.prototype = {   
    ...
    *******************************/    
    ...
    endedListener: function(obj) {
        // console.log("hier", this.media.maxpos, this.getState(), this.mediaElement)
	if (this.mediaElement===null) return;
...
projekktorControlbar.prototype = {
	...
	this.cb.mouseenter(function(event){ref.controlsFocus(event); });		
	this.cb.mouseleave(function(event){ref.controlsBlur(event); });	        	
    },
